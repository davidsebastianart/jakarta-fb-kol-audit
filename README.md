...
🔗 > [**Interactive Dashboard (Looker Studio)**](https://datastudio.google.com/reporting/fa952fc2-3cd4-4353-b6b3-6b2d91f87861)
🔗 [**Download/View Executive Deck (PPTX)**](Jakarta F&B KOL Authenticity Audit.pptx)
...
* `master_dataset_clean.csv` : Dataset mentah hasil ekstraksi awal.
